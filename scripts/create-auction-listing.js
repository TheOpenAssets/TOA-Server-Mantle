...
/**
 * Create Auction Listing on PrimaryMarket
 * Reads asset from backend and creates auction listing
 */
...
if (!assetId) {
  console.error('❌ Usage: node create-auction-listing.js <assetId>');
  process.exit(1);
}
...
async function main() {
  console.log('\n🔨 Creating auction listing for asset:', assetId);
  ...
  console.log('   Reserve:', `$${asset.reservePrice}`);
  console.log('   Duration:', `${asset.auctionDuration}s`);
