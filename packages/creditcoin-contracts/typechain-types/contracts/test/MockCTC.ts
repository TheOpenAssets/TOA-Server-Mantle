...
export interface MockCTCInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "allowance"
      | "approve"
...
export interface MockCTC extends BaseContract {
  connect(runner?: ContractRunner | null): MockCTC;
  waitForDeployment(): Promise<this>;

  interface: MockCTCInterface;
