...
export interface MockStARBInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "allowance"
      | "approve"
...
export interface MockStARB extends BaseContract {
  connect(runner?: ContractRunner | null): MockStARB;
  waitForDeployment(): Promise<this>;

  interface: MockStARBInterface;
