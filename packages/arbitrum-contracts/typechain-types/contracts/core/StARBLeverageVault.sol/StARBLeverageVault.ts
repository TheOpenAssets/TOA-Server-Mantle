...
export declare namespace StARBLeverageVault {
  export type PositionStruct = {
    user: AddressLike;
    stARBCollateral: BigNumberish;
...
export interface StARBLeverageVaultInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "BASIS_POINTS"
      | "INITIAL_LTV"
  ...
  encodeFunctionData(
    functionFragment: "arbitrumSwapIntegration",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export namespace PositionLiquidatedEvent {
  export type InputTuple = [
    positionId: BigNumberish,
    bufferStARBSold: BigNumberish,
    usdcRecovered: BigNumberish,
    baseStARBReturned: BigNumberish,
    debtRepaid: BigNumberish
  ];
  export type OutputTuple = [
    positionId: bigint,
    bufferStARBSold: bigint,
    usdcRecovered: bigint,
    baseStARBReturned: bigint,
    debtRepaid: bigint
  ];
  export interface OutputObject {
    positionId: bigint;
...
export interface StARBLeverageVault extends BaseContract {
  connect(runner?: ContractRunner | null): StARBLeverageVault;
  waitForDeployment(): Promise<this>;

  interface: StARBLeverageVaultInterface;
  ...
  addCollateral: TypedContractMethod<
    [positionId: BigNumberish, stARBAmount: BigNumberish],
    [void],
    "nonpayable"
  >;

  arbitrumSwapIntegration: TypedContractMethod<[], [string], "view">;
  ...
  getHealthFactor: TypedContractMethod<
    [positionId: BigNumberish, stARBPriceUSD: BigNumberish],
    [bigint],
    "view"
  >;
  ...
  getPosition: TypedContractMethod<
    [positionId: BigNumberish],
    [StARBLeverageVault.PositionStructOutput],
    "view"
  >;
  ...
  >;
  getFunction(
    nameOrSignature: "arbitrumSwapIntegration"
