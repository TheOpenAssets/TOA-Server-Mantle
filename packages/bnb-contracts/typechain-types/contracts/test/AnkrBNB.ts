...
export interface AnkrBNBInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "allowance"
      | "approve"
...
export interface AnkrBNB extends BaseContract {
  connect(runner?: ContractRunner | null): AnkrBNB;
  waitForDeployment(): Promise<this>;

  interface: AnkrBNBInterface;
