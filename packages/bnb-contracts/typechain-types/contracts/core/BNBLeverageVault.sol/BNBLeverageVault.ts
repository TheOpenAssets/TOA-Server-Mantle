...
export declare namespace BNBLeverageVault {
...
export interface BNBLeverageVaultInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "BASIS_POINTS"
      | "INITIAL_LTV"
  ...
  encodeFunctionData(
    functionFragment: "bnbSwapIntegration",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface BNBLeverageVault extends BaseContract {
  connect(runner?: ContractRunner | null): BNBLeverageVault;
  waitForDeployment(): Promise<this>;

  interface: BNBLeverageVaultInterface;
  ...
  bnbSwapIntegration: TypedContractMethod<[], [string], "view">;
  ...
  getPosition: TypedContractMethod<
    [positionId: BigNumberish],
    [BNBLeverageVault.PositionStructOutput],
    "view"
  >;
  ...
  >;
  getFunction(
    nameOrSignature: "bnbSwapIntegration"
