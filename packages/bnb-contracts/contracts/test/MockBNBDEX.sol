...
/**
 * @title MockBNBDEX
 * @notice Mock DEX for testing stARB ↔ USDC swaps on BNB
 ...
 * - Liquidity tracking
 */
contract MockBNBDEX is Ownable, ReentrancyGuard {
    IERC20 public stARB;
    IERC20 public USDC;
    ...
    /**
    * @notice Initialize Mock BNB DEX
    * @param _stARB collateral token address
