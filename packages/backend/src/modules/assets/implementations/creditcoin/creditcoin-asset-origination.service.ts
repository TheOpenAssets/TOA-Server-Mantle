...
@Injectable()
export class CreditCoinAssetOriginationService implements IAssetOriginationService {
  private readonly logger = new Logger(CreditCoinAssetOriginationService.name);
