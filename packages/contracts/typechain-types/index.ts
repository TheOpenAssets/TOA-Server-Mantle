...
export type { MockMETH } from "./contracts/test/METHFaucet.sol/MockMETH";
export { MockMETH__factory } from "./factories/contracts/test/METHFaucet.sol/MockMETH__factory";
