...
export interface YieldVaultInterface extends Interface {
  ...
  encodeFunctionData(
    functionFragment: "getClaimableForTokens",
    values: [AddressLike, BigNumberish]
  ): string;
  encodeFunctionData(
...
export namespace SettlementDepositedEvent {
  export type InputTuple = [
    tokenAddress: AddressLike,
    assetId: BytesLike,
    totalSettlement: BigNumberish,
    totalTokenSupply: BigNumberish,
...
export interface YieldVault extends BaseContract {
  ...
  getClaimableForTokens: TypedContractMethod<
    [tokenAddress: AddressLike, tokenAmount: BigNumberish],
    [bigint],
    "view"
  >;
  ...
  getFunction(
    nameOrSignature: "getClaimableForTokens"
  ): TypedContractMethod<
    [tokenAddress: AddressLike, tokenAmount: BigNumberish],
    [bigint],
    "view"
  ...
  filters: {
    ...
    "SettlementDeposited(address,bytes32,uint256,uint256,uint256)": TypedContractEvent<
      SettlementDepositedEvent.InputTuple,
      SettlementDepositedEvent.OutputTuple,
      SettlementDepositedEvent.OutputObject
    >;
    SettlementDeposited: TypedContractEvent<
      SettlementDepositedEvent.InputTuple,
      SettlementDepositedEvent.OutputTuple,
      SettlementDepositedEvent.OutputObject
    >;
