...
import LeverageVault from '../../artifacts/contracts/core/LeverageVault.sol/LeverageVault.json';
...
import FluxionIntegration from '../../artifacts/contracts/integrations/FluxionIntegration.sol/FluxionIntegration.json';
import MockFluxionDEX from '../../artifacts/contracts/test/MockFluxionDEX.sol/MockFluxionDEX.json';
import MockMETH from '../../artifacts/contracts/test/MockMETH.sol/MockMETH.json';
import METHFaucet from '../../artifacts/contracts/test/METHFaucet.sol/METHFaucet.json';
...
export const MantleAbis: Partial<Record<ContractName, any>> = {
  ...
  LeverageVault: LeverageVault.abi,
  SeniorPool: SeniorPool.abi,
  OAID: OAID.abi,
  MockUSDC: MockUSDC.abi,
  FluxionIntegration: FluxionIntegration.abi,
  MockFluxionDEX: MockFluxionDEX.abi,
  MockMETH: MockMETH.abi,
  METHFaucet: METHFaucet.abi,
  Faucet: Faucet.abi,
